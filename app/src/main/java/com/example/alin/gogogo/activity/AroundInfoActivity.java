...
public class AroundInfoActivity extends AppCompatActivity {
    ...
    public class MyLocationListener implements BDLocationListener {
      private String Describe;
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            MyLocationData data = new MyLocationData.Builder().latitude(location.getLatitude()) .longitude(location.getLongitude()).build();
    ...
    private void setMarker() {
        ...
        BitmapDescriptor bitmap = BitmapDescriptorFactory
                .fromResource(R.mipmap.map_lication_my);
